			...
			<div class="panel red-bg">
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-xs-8">
							<span class="state-title"> Total Rents </span>
					...
					<div class="panel">
						<div class="panel-body">
							<div style="margin-bottom: 10px;">
								<a class="btn p-follow-btn" href="mailto:ask@zestpik.in"> 
									<i class="fa fa-envelope"></i> &nbsp; ask@zestpik.in 
								</a>
							</div>
							<div style="margin-bottom: 10px;">
								<a class="btn p-follow-btn" href="callto:+919535116477" style="margin-right: 8px;"> 
									<i class="fa fa-phone"></i> &nbsp; +91 9535116477
								</a>
								<a class="btn p-follow-btn" href="#"> 
									<i class="fa fa-twitter"></i> &nbsp; ZestPik
								</a>
							</div>
						</div>
					</div>
						...
						<div class="carousel slide auto panel-body" id="c-slide">
							...
							<div class="carousel-inner">
								<div class="item text-center active">
									<h3> ZestPik | Online Marketplace </h3>
									<p> frontEnd Development </p>
									<p class="text-muted">
										ZestPik.in is a e-Marketplace application where all of the data is totally dynamic content
									</p>
								</div>
