...
<html lang="en">
	...
	<?php
			...
			if($pageName === 'index')
			{
				$pageTitle = ucwords('Online Marketplace');
			}
			else
			{
			...
			<div class="left-side sticky-left-side">														
				<div class="logo">
					<a href="dashboard.php">
						<img src="../public/assets/images/favicon/ZestPikpower.png" alt="" height="36px">
					</a>
				</div>
				<div class="logo-icon text-center">
					<a href="dashboard.php">
						<img src="../public/assets/images/favicon/ZestPikpower.png" alt="" height="34px" width="34px">
					</a>
				</div>
