					...
					<div class="container">
						<div class="row">
							...
							<div class="col-lg-3 col-md-6">
								<div class="widget">
									<h4 class="widget-title">SERVICE'S OFFERED</h4>
									<p>ZestPik is All in One Rental Market platform ! built as market aggregator for Renter's and Hirer's in INDIA. </p>
									<p> 
										<li> RENT A PRODUCT </li>
										<li> HIRE A PRODUCT </li>
							...
							<div class="col-lg-5 col-md-6">
								<div class="widget widget-newsletter">
									...
									<p>Get all the latest information on Newly listed products on ZestPik. Sign up for newsletter today !</p>
							...
							<div class="col-lg-4 col-md-6">
								<div class="widget">
									<ul class="contact-info">
										<li><span class="contact-info-label">Address:</span>2nd ward sc colony Emmiganur (p), Kampli (t) & Ballari (d), karnataka (s),INDIA - 583113.</li>
										<li><span class="contact-info-label">Mobile no:</span> <a href="#"> +91 9535116477 </a></li>
										<li><span class="contact-info-label">Email:</span> <a href="#">praveenh683@gmail.com</a></li>
										<li><span class="contact-info-label">Working Days/Hours:</span>Mon - Fri / 10:00AM - 6:00PM</li>
									</ul>
								</div>
							</div>
						</div>
				...
				<div class="container">
					<div class="footer-bottom">
						<p class="footer-copyright mt-1">All Rights Reserved &copy; <?= date('Y') ?> | 
							<a href="#" target="_blank"> JANAPRABHA TECH PRIVATE LIMITED.</a>
						</p>
						<div class="social-icons">
							<a><img style="height: 33px; padding-left: 16px;" src="public/assets/images/icons/bhim.png" alt=""></a>
							<a><img style="height: 33px; padding-left: 16px;" src="public/assets/images/icons/gpay.png" alt=""></a>
							<a><img style="height: 33px; padding-left: 16px;" src="public/assets/images/icons/phonepay.png" alt=""></a>
							<a><img style="height: 33px; padding-left: 16px;" src="public/assets/images/icons/paytm.png" alt=""></a>
							<a><img style="height: 33px; padding-left: 16px;" src="public/assets/images/icons/paypal.png" alt=""></a>
							<a><img style="height: 33px; padding-left: 16px;" src="public/assets/images/icons/razorpay.png" alt=""></a>
							<a><img style="height: 33px; padding-left: 16px;" src="public/assets/images/icons/sbipay.png" alt=""></a>
						</div>
						<div class="social-icons">
							
							<a href="https://www.instagram.com/zestpikrenters?utm_source=qr&igsh=dXdzNjR4b3JyMXFt" class="social-icon" target="_blank">
								<i class="icon-instagram"></i>
							</a>
											
							<a href="https://www.facebook.com/profile.php?id=61561895107867&mibextid=ZbWKwL" class="social-icon" target="_blank">
				...
				<div class="modal-content">
					<div class="cuspop" style="background-image: url('public/assets/images/menu-bg.png')">
						...
						<div class="modal-body">
							...
							<p>Subscribe to the <b> ZestPik </b>  newsletter <br/> to receive timely updates from newly listed products.</p>
							<form action="" method="post">
								<div class="row">
