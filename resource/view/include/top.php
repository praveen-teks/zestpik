...
<html lang="en">
	<head>
		...
		<meta name="keywords" content="e-Marketplace" />
		<meta name="description" content="Full Stack Web Developer">
		<meta name="author" content="Praveen H">
		<title> ZestPik | <?php echo $pageTitle ?> </title>
				...
				<div class="header-top">
					<div class="container">
						<div class="header-left header-dropdowns">
							...
							<a href="#"><img src="public/assets/images/favicon/bd.svg" alt="India flag">INDIA</a>
								<div class="header-menu">
									<ul>
										<li><a href="#">BANGLADESH</a></li>
										<li><a href="#">SRILANKA</a></li>
										<li><a href="#">PAKISTAN</a></li>
										<li><a href="#">MAYANAMAR</a></li>
										<li><a href="#">JAPAN</a></li>
									</ul>
								</div>
							</div>
							<div class="header-dropdown">
								<a href="#"><img src="public/assets/images/favicon/bd.svg" alt="Bangladesh flag">CURRENT LOCATION</a>
								
							</div>
						</div>
						<div class="header-right">
							<p class="welcome-msg">WEL COME ! 
					...
					<div class="container">
						<div class="header-left">
							<a href="index.php" class="logo">
								<img style="height: 60px;" src="public/assets/images/favicon/ZestPikpower.png" alt="ZestPik Logo">
							</a>
						</div>
						...
						<div class="header-right">
							...
							<div class="header-contact"><span>Call us now</span>
								<a href="tel:#"><strong>+91 9535116477</strong></a>
							</div>
