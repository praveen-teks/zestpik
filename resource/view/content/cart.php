					...
					if(isset($_POST['discount_amnt']))
					{
						if(@$getDiscount > 0) {
							...
							<div class="alert alert-success alert-dismissible fade show" role="alert">
								<strong>Congratulation!</strong> You have get INR'. @$_SESSION['SSCF_DISCOUNT_AMOUNT'] .' tk discount.
					...
					<form action="" method="post">
						<div class="input-group">
							<select class="form-control" name="shipping_method">
								...
								<option value="50"> INR 50 Rs Inside of Dhaka  </option>
								<option value="120"> INR 120 Rs Outside of Dhaka </option>
							</select>
							<div class="input-group-append">
